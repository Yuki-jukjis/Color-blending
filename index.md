...
3枚以上のレイヤの合成は、一番下の2枚を計算してから、その結果を下のレイヤーとして対して3枚目を合成し、その結果に4枚目を……という手順のはずです。ちなみにレイヤーを結合するときに下から順にやらないと結果が変わってしまうのはこのせい。
...
![焼き込みカラーのグラフ](plots/burn_rgba.png)  
![焼き込みカラーのサンプル](samples/burn_rgba.png)  
...
xとyそれぞれのrgbの値から輝度を計算し、xの方が小さかったらxを、yのほうが小さかったらyを採用します。輝度はrgbを3:6:1くらいで混ぜると得られます。  
...
![覆い焼きカラーのグラフ](plots/dodge_rgba.png)  
![覆い焼きカラーのサンプル](samples/dodge_rgba.png)  
